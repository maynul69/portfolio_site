              ...
              <div className="row">
                <div className="col-lg-5 col-md-5 col-sm-5">
                  <div className="contact-page-item">
                    <h2>My Contacts</h2>
                    <p>Contact me for any further discussion or question.</p>
                    ...
                    <div className="phone">
                      <h3>Phone</h3>
                      <span>0174940589</span>
                      <span>01996247363</span>
                    </div>
                    <div className="email">
                      <h3>Email</h3>
                      <span>maynulhossain69@gmail.com</span>
                    </div>
                  </div>
                </div>
                <div className="col-lg-7 col-md-7 col-sm-7">
                  <div className="contact-area contact-area-2 contact-area-3">
                    ...
                    <div className="contact-form">
                      <form
                        action="https://formspree.io/f/myyoarzo"
                        method="POST"
